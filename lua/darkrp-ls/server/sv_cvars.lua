...
-- Generic convars
CreateConVar("darkrp_ls_connection", "15", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The amount of xp to get when a player connects.")
CreateConVar("darkrp_ls_kill", "15", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The amount of xp to get when a player kills someone.")
...
CreateConVar("darkrp_ls_buy_door", "2", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The amount of xp to get when a buys a door.")
...
CreateConVar("darkrp_ls_player_hit_success", "40", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The amount of xp to get when a player hits someone successfully.")
CreateConVar("darkrp_ls_player_hit_fail", "8", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The amount of xp to get when a player hits someone unsuccessfully.")
